...
<div data-options="region:'center',title:'',border:false">
    ...
    <div id="toolBar" style="vertical-align: center">
        ...
        <form id="form" style="margin-bottom: 0px">
            <input id="keyword" name="keyword"  class="easyui-textbox" data-options="prompt:'输入监测因子名称或英文名...'">
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/monitofactors.js"></script>
<script type="text/javascript">
