...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false">
        ...
        <div id="footer" style="color:green;text-align:center">温馨提示:如果修改了监测站数据,下拉框中的值不对应,请刷新页面</div>
    </div>
</div>
<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/monitorsite.js"></script>
