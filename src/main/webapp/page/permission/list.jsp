...
<div class="easyui-layout" data-options="fit:true,border:false">
    <div data-options="region:'center',border:false">
        ...
        <div id="toolbar">
            <div>
                ...
                <shiro:hasPermission name="删除权限">
                    ...
                    <a href="javascript:void(0);" class="easyui-linkbutton"
                       data-options="plain:true,iconCls:'icon-reload'" onclick="cleanFun()">刷新</a>
            </div>
        ...
        <div id="footer" style="color:green;text-align:center">温馨提示:如果修改了资源数据,下拉框中的值不对应,请刷新页面</div>
    </div>
</div>

<script type="text/javascript" src="${pageContext.request.contextPath}/js/module/permission.js"></script>
